...
// WithDefaultFloat64 returns the float value of the supplied environment variable or, if not present,
// the supplied default value. If the float conversion fails, returns the default
